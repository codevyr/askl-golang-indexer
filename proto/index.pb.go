...
type Object struct {
	...
	ContentHash     string                 `protobuf:"bytes,9,opt,name=content_hash,json=contentHash,proto3" json:"content_hash,omitempty"`             // SHA256 hex; when set, content (field 6) may be empty
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *Object) GetContentHash() string {
	if x != nil {
...
type ObjectContent struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ContentHash   string                 `protobuf:"bytes,1,opt,name=content_hash,json=contentHash,proto3" json:"content_hash,omitempty"` // SHA256 hex (lowercase)
...
func (x *ObjectContent) GetContentHash() string {
	if x != nil {
		return x.ContentHash
	}
	return ""
...
func (x *ObjectContent) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
type ContentBatch struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Contents      []*ObjectContent       `protobuf:"bytes,1,rep,name=contents,proto3" json:"contents,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ContentBatch) Reset() {
	*x = ContentBatch{}
...
func (x *ContentBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ContentBatch) ProtoMessage() {}

func (x *ContentBatch) ProtoReflect() protoreflect.Message {
	mi := &file_proto_index_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ContentBatch.ProtoReflect.Descriptor instead.
func (*ContentBatch) Descriptor() ([]byte, []int) {
	return file_proto_index_proto_rawDescGZIP(), []int{3}
}

func (x *ContentBatch) GetContents() []*ObjectContent {
	if x != nil {
		return x.Contents
	}
	return nil
...
const file_proto_index_proto_rawDesc = "" +
	...
	"\asymbols\x18\x05 \x03(\v2\x12.askl.index.SymbolR\asymbolsJ\x04\b\x03\x10\x04\"\xbe\x02\n" +
	"\x06Object\x12\x19\n" +
	...
	"\x04refs\x18\b \x03(\v2\x15.askl.index.SymbolRefR\x04refs\x12!\n" +
	"\fcontent_hash\x18\t \x01(\tR\vcontentHashJ\x04\b\x02\x10\x03\"L\n" +
	"\rObjectContent\x12!\n" +
	"\fcontent_hash\x18\x01 \x01(\tR\vcontentHash\x12\x18\n" +
	"\acontent\x18\x02 \x01(\fR\acontent\"E\n" +
	"\fContentBatch\x125\n" +
	"\bcontents\x18\x01 \x03(\v2\x19.askl.index.ObjectContentR\bcontents\"\x92\x01\n" +
	"\x06Symbol\x12\x19\n" +
...
var file_proto_index_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_proto_index_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_index_proto_goTypes = []any{
	...
	(*ObjectContent)(nil),  // 5: askl.index.ObjectContent
	(*ContentBatch)(nil),   // 6: askl.index.ContentBatch
	(*Symbol)(nil),         // 7: askl.index.Symbol
	(*SymbolInstance)(nil), // 8: askl.index.SymbolInstance
	(*SymbolRef)(nil),      // 9: askl.index.SymbolRef
}
var file_proto_index_proto_depIdxs = []int32{
	4, // 0: askl.index.Project.objects:type_name -> askl.index.Object
	7, // 1: askl.index.Project.symbols:type_name -> askl.index.Symbol
	8, // 2: askl.index.Object.symbol_instances:type_name -> askl.index.SymbolInstance
	9, // 3: askl.index.Object.refs:type_name -> askl.index.SymbolRef
	5, // 4: askl.index.ContentBatch.contents:type_name -> askl.index.ObjectContent
	0, // 5: askl.index.Symbol.scope:type_name -> askl.index.SymbolScope
	1, // 6: askl.index.Symbol.type:type_name -> askl.index.SymbolType
	2, // 7: askl.index.SymbolInstance.instance_type:type_name -> askl.index.InstanceType
